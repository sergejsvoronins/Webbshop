...
createProduct("Thin Case","/assets/img/ipad-green","apple","grön","549",0, false, "tablet",productList);
createProduct("Thin Case","/assets/img/ipad-blue.png","apple","blå","549",0, false, "tablet",productList);
createProduct("Thin Case","/assets/img/ipad-rose.png","apple","röd","549",0, false, "tablet",productList);
...
createProduct("Thin Case","/assets/img/mackbook-case.png","apple","svart","849",0, false, "desktop",productList);
